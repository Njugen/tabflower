      ...
      if (isString(containerId)) {
        ...
        if (newTabInContainerIds !== false) {
          if (containerId === "all") {
            ...
            const index = newTabInContainerIds.findIndex(
    ...
    return (
      <div className="addNewWindowForm">
        ...
        <TBTextInput
          id="newWindowURL"
          label="URL"
          value={this.state.newWindowURL || "https://"}
          onChange={(id, value) =>
            this.handleAddNewWindowInputChange(id, value)
          }
        ></TBTextInput>
        <div className="text-aligner p-3">
          <button
            className="btn btn-secondary"
            onClick={() => this.hideAddNewWindowForm()}
          >
            Cancel
          </button>
          <button
            className="btn-tabeon btn"
            onClick={() => this.raiseNewWindowToModal(this.state.newWindowURL)}
          >
            Save window
          </button>
        </div>
    ...
    return (
      <div className="addNewTabForm">
        ...
        <TBTextInput
          ...
          label="URL"
          value={this.state.newWindowURL || "https://"}
          onChange={(id, value) => this.handleAddNewTabInputChange(id, value)}
        ></TBTextInput>
        <div className="text-aligner p-3">
          <button
            className="btn btn-secondary"
            onClick={() => this.cancelNewTab(containerId)}
          >
            Cancel
          </button>
          <button
            className="btn-tabeon btn"
            onClick={() =>
              this.raiseNewTabToModal(this.state.newTabURL, windowIndex, () => {
