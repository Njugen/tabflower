...
describe("Test <ETGMRemoveGroupsModal /> component behaviour at mount", () => {
  const actualErrorReturns = {
    "ETGMRemoveGroupsModal-101": ExceptionsHandler.ValidatorError(
      "ETGMRemoveGroupsModal-101"
    ),
    "ETGMRemoveGroupsModal-102": ExceptionsHandler.ValidatorError(
      "ETGMRemoveGroupsModal-102"
    ),
    "ETGMRemoveGroupsModal-103": ExceptionsHandler.ValidatorError(
      "ETGMRemoveGroupsModal-103"
    ),
    "ETGMRemoveGroupsModal-104": ExceptionsHandler.ValidatorError(
      "ETGMRemoveGroupsModal-104"
    ),
    "ETGMRemoveGroupsModal-105": ExceptionsHandler.ValidatorError(
      "ETGMRemoveGroupsModal-105"
    ),
    "ETGMRemoveGroupsModal-106": ExceptionsHandler.ValidatorError(
      "ETGMRemoveGroupsModal-106"
    ),
    "ETGMRemoveGroupsModal-107": ExceptionsHandler.ValidatorError(
      "ETGMRemoveGroupsModal-107"
    ),
    "ETGMRemoveGroupsModal-108": ExceptionsHandler.ValidatorError(
      "ETGMRemoveGroupsModal-108"
    ),
  };
  ...
  describe("Test verifyChildProps()", () => {
    describe("Examine the function based on the value of this.props.data", () => {
      test('Run verifyChildProps(): If "data" is missing in this.props, throw an error "ETGMRemoveGroupsModal-105"', () => {
        expect(() => {
          ...
          ExceptionsHandler.ValidatorError("ETGMRemoveGroupsModal-105")
        );
      });

      test.each(various_nonObjects)(
        'Run verifyChildProps(): If "data" = %p (is not an object) in this.props, throw an error "ETGMRemoveGroupsModal-105"',
        (val) => {
          expect(() => {
            const presetProps = {
              data: val,
    ...
    describe("Examine the function based on the value of this.props.data.params", () => {
      test('Run verifyChildProps(): If "params" is missing in this.props.data, throw an error "ETGMRemoveGroupsModal-104"', () => {
        expect(() => {
          const presetProps = {
            data: {},
          };
          ...
          ExceptionsHandler.ValidatorError("ETGMRemoveGroupsModal-104")
        );
      });

      test.each(various_nonObjects)(
        'Run verifyChildProps(): If "params" = %p (is not an object) in this.props.data, throw an error "ETGMRemoveGroupsModal-104"',
        (val) => {
          expect(() => {
            const presetProps = {
              data: {
      ...
      test('Run verifyChildProps(): If "params" is an object in this.props.data is an object, do NOT throw error "ETGMRemoveGroupsModal-104"', () => {
        expect(() => {
          const presetProps = {
            data: {
              params: {},
      ...
      describe("Examine the function, when this.props.data.params.removeAll is undefined", () => {
        describe('Examine the "groupId" key located in this.props.data.params', () => {
          test.each(various_nonString)(
            'Run verifyChildProps(): If "groupId" key is not a string, throw an error "ETGMRemoveGroupsModal-102"',
            (val) => {
              expect(() => {
                const presetProps = {
                  data: {
                ...
                ExceptionsHandler.ValidatorError("ETGMRemoveGroupsModal-102")
              );
            }
          );
        ...
        describe('Examine the "groupName" key located in this.props.data.params', () => {
          test.each(various_nonString_nonUndefined)(
            'Run verifyChildProps(): If "groupName" key is not a string, throw an error "ETGMRemoveGroupsModal-103"',
            (val) => {
              expect(() => {
                const presetProps = {
                  data: {
                ...
                ExceptionsHandler.ValidatorError("ETGMRemoveGroupsModal-103")
              );
            }
          );

          test('Run verifyChildProps(): If "groupName" key is missing, throw an error "ETGMRemoveGroupsModal-103"', () => {
            expect(() => {
              const presetProps = {
                data: {
                  params: {
  ...
  describe("Test saveModalHandler(callback)", () => {
    describe("Case 1: When callback is a function", () => {
      ...
      describe("Examine the function based on the value of this.props.data", () => {
        ...
        test.each(various_nonObjects)(
          'Run saveModalHandler(callback): If "data" = %p (is not an object) in this.props, throw an error "ETGMRemoveGroupsModal-105"',
          (val) => {
            const presetProps = {
              data: val,
            };
      ...
      describe("Examine the function based on the value of this.props.data.params", () => {
        ...
        test.each(various_nonObjects)(
          'Run saveModalHandler(callback): If "params" = %p (is not an object) in this.props.data, throw an error "ETGMRemoveGroupsModal-104"',
          (val) => {
            const presetProps = {
              data: {
                params: val,
      ...
      describe('Examine the function based on the value of "callback" input parameter', () => {
        ...
        test("Run saveModalHandler(callback): If this.props.data and this.props.data.params are valid, call this.clearModalData(callback) which in turns calls the callback function (the callback function receives an object input defined in this test case)", () => {
          ...
          expect(callback).toHaveBeenCalledWith(
            componentInstance.props.data.params
          );
        });
      });
    });
  ...
  describe("Test renderBodyContents()", () => {
    describe('Examine "data" parameter', () => {
      test('Run renderBodyContents(data): If "data" parameter is undefined, throw the error message of "ETGMRemoveGroupsModal-106"', () => {
        expect(() => componentInstance.renderBodyContents()).toThrow(
          expectedErrorReturns["ETGMRemoveGroupsModal-106"].message
        );
      });

      test.each(various_nonObjects)(
        'Run renderBodyContents(%p): throw the error message of "ETGMRemoveGroupsModal-106"',
        (val) => {
      ...
      test('Run renderBodyContents(data): If "data" is an object, do not throw error message of "ETGMRemoveGroupsModal-106"', () => {
        componentInstance = testComponent.instance();
  ...
  describe("Test renderHeaderContents()", () => {
    describe('Examine "data" parameter', () => {
      test('Run renderHeaderContents(data): If "data" parameter is undefined, throw the error message of "ETGMRemoveGroupsModal-107"', () => {
        expect(() => componentInstance.renderHeaderContents()).toThrow(
          expectedErrorReturns["ETGMRemoveGroupsModal-107"].message
        );
      });

      test.each(various_nonObjects)(
        'Run renderHeaderContents(%p): throw the error message of "ETGMRemoveGroupsModal-107"',
        (val) => {
      ...
      test('Run renderHeaderContents(data): If "data" is an object, do not throw error message of "ETGMRemoveGroupsModal-107"', () => {
        componentInstance = testComponent.instance();
  ...
  describe("Test renderFooterContents()", () => {
    describe('Examine "data" parameter', () => {
      test('Run renderFooterContents(data): If "data" parameter is undefined, throw the error message of "ETGMRemoveGroupsModal-108"', () => {
        expect(() => componentInstance.renderFooterContents()).toThrow(
          expectedErrorReturns["ETGMRemoveGroupsModal-108"].message
        );
      });

      test.each(various_nonObjects)(
        'Run renderFooterContents(%p): throw the error message of "ETGMRemoveGroupsModal-108"',
        (val) => {
      ...
      test('Run renderFooterContents(data): If "data" is an object, do not throw error message of "ETGMRemoveGroupsModal-108"', () => {
        componentInstance = testComponent.instance();
