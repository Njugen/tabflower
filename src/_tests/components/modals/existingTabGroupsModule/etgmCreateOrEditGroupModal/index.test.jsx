      ...
      describe("When this.props.data is an object, examine this.props.data.params", () => {
        ...
        describe("When this.props.data.params, examine its contents and expect results accordingly", () => {
          ...
          describe("Examine this.props.data.params.windowAndTabs", () => {
            ...
            test('Run verifyChildProps(): If this.props.data.params.windowAndTabs is en empty array, do not throw an error "ETGMCreateNewGroupModal-119"', () => {
              expect(() => {
                const presetProps = {
                  data: {
                    params: {
            ...
            test.each(various_nonArray_except_undefined)(
              'Run verifyChildProps(): If this.props.data.params.windowAndTabs = %p (not an array and not undefined), throw an error "ETGMCreateNewGroupModal-119"',
              (val) => {
                expect(() => {
                  const presetProps = {
                    data: {
  ...
  describe("Test childComponentDidMount()", () => {
    ...
    describe('Examine the "data" object of this.props', () => {
      ...
      describe('Examine the "params" object of this.props.data', () => {
        ...
        test.each(various_nonObjects)(
          'Run childComponentDidMount(): if this.props.data.params = %p (is not an object), throw an error "ETGMCreateNewGroupModal-127"',
          (val) => {
            const presetProps = {
              data: {
                params: val,
      ...
      describe('Examine the "windowAndTabs" array of this.props.data.params', () => {
        ...
        test.each(various_nonArrays)(
          'Run childComponentDidMount(): If this.props.data.params.windowAndTabs = %p (is not an array), throw an error "ETGMCreateNewGroupModal-128"',
          (val) => {
            const presetProps = {
              data: {
                params: {
        ...
        test("Run childComponentDidMount(): If this.props.data.params.windowAndTabs is an array, pass it to this.saveToState() with correct parameters", () => {
          ...
          expect(componentInstance.saveToState).toHaveBeenCalledWith(
            "windowAndTabs",
            presetProps.data.params.windowAndTabs,
            "tabGroupDetails"
          );
        });
  ...
  describe("Test renderModalBody()", () => {
    describe('Examine "data" key of this.props', () => {
      test('Run renderModalBody(): If "data" props is undefined, return the error message of "ETGMCreateNewGroupModal-136"', () => {
        ...
        expect(componentInstance.renderModalBody()).toBe(
          expectedErrorReturns["ETGMCreateNewGroupModal-136"].message
        );
      });

      test.each(various_nonObjects)(
        'Run renderModalBody(): If "data" = %p (not an object) in props, return the error message of "ETGMCreateNewGroupModal-136"',
        (val) => {
          const presetProps = {
            data: val,
          };
      ...
      test('Run renderModalBody(): If "data" props is an object, do not return the error message of "ETGMCreateNewGroupModal-136"', () => {
        ...
        expect(componentInstance.renderModalBody()).not.toBe(
          expectedErrorReturns["ETGMCreateNewGroupModal-136"].message
        );
      });
    });
    ...
    describe('Examine "params" key of this.props.data, assuming data is an object', () => {
      test('Run renderModalBody(): If data.params is undefined, return the error message of "ETGMCreateNewGroupModal-135"', () => {
        ...
        expect(componentInstance.renderModalBody()).toBe(
          expectedErrorReturns["ETGMCreateNewGroupModal-135"].message
        );
      });

      test.each(various_nonObjects)(
        'Run renderModalBody(): If data.parans = %p (not an object) in props, return the error message of "ETGMCreateNewGroupModal-135"',
        (val) => {
          const presetProps = {
            data: {
              params: val,
        ...
        const presetProps = {
          data: {
            params: {
              ...
              groupCloseInactiveTabs: true,
              groupDescription:
                "A tab group preset ub a test suite. This tab group is not real and is not actually stored anywhere.",
              type: "new-group",
            },
          },
        };
  ...
  describe("Test renderModalHeader()", () => {
    describe('Examine "data" key of this.props', () => {
      test('Run renderModalHeader(): If "data" props is undefined, return the error message stated in this test case', () => {
        ...
        expect(componentInstance.renderModalHeader()).toBe(
          "Data section is missing in component props"
        );
      });

      test.each(various_nonObjects)(
        'Run renderModalHeader(): If "data" = %p (not an object) in props, return the error message of "ETGMCreateNewGroupModal-136"',
        (val) => {
          const presetProps = {
            data: val,
          };
      ...
      test('Run renderModalHeader(): If "data" props is an object, do not return the error message of "ETGMCreateNewGroupModal-136"', () => {
        ...
        expect(componentInstance.renderModalHeader()).not.toBe(
          "Data section is missing in component props"
        );
      });
    });
    ...
    describe('Examine "params" key of this.props.data, assuming data is an object', () => {
      test("Run renderModalHeader(): If data.params is undefined, return the error message stated in this test case", () => {
        ...
        expect(componentInstance.renderModalHeader()).toBe(
          "Data parameters are missing"
        );
      });

      test.each(various_nonObjects)(
        "Run renderModalHeader(): If data.parans = %p (not an object) in props, return the error message stated in this test case",
        (val) => {
          const presetProps = {
            data: {
              params: val,
      ...
      test('Run renderModalHeader(): If data.params.type = "existing-group", return the error message given in this test case', () => {
        ...
        expect(componentInstance.renderModalHeader()).toBe(
          'Edit the "' +
            (presetProps.data.params.groupName || "") +
            '" tab group'
        );
      });
