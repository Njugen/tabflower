...
describe("Test <AboutTabFlowerView /> component behaviour at mount", () => {
  const actualErrorReturns = {
    "aboutTabflower-view-101": ExceptionsHandler.ValidatorError(
      "aboutTabflower-view-101"
    ),
    "aboutTabflower-view-102": ExceptionsHandler.ValidatorError(
  ...
  describe("test handleRaiseToView(data)", () => {
    describe('Case 1: When "data" is NOT a string', () => {
      ...
      test('Run handleRaiseToView(): The error ExceptionsHandler.ValidatorError("aboutTabflower-view-101") should be thrown', () => {
      ...
      test.each(various_nonString_values)(
        'Run handleRaiseToView(%p): The error ExceptionsHandler.ValidatorError("aboutTabflower-view-101") should be thrown',
        (val) => {
    ...
    describe('Case 2: When "data" is a string, but the string is invalid (invalid means data != "refresh")', () => {
      test('Run handleRaiseToView("buyMeSweets"): The error The error ExceptionsHandler.ValidatorError("aboutTabflower-view-102") should b e thrown', () => {
